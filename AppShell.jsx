...
const ICONS = {
  ...
  back: () => `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1E1408" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>`,
  search: () => `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9A8878" stroke-width="1.8" stroke-linecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>`,
  ...
  scan: () => `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7A6652" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/><line x1="3" y1="12" x2="21" y2="12"/></svg>`,
  settings: () => `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7A6652" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>`,
};
...
function StatusBar() {
  ...
  return React.createElement('div', {
    style: {
      ...
      background: '#FEFAF3', flexShrink: 0,
    }
  },
    React.createElement('span', { style: { fontFamily: "'Nunito', sans-serif", fontWeight: 700, fontSize: 15, color: '#1E1408' } }, time),
    React.createElement('div', { style: { display: 'flex', gap: 6, alignItems: 'center' } },
      React.createElement('span', { style: { fontSize: 13, color: '#1E1408' } }, '●●●●'),
      React.createElement('span', { style: { fontSize: 13, color: '#1E1408' } }, '▲'),
      React.createElement('span', { style: { fontWeight: 700, fontSize: 13, color: '#1E1408' } }, '100%'),
    )
  );
}

function StatusBarSpacer() {
  // On mobile, add top safe area padding (for iPhone notch)
  if (!_isMobile()) return null;
  return React.createElement('div', {
    style: { height: 'env(safe-area-inset-top, 0px)', background: '#FEFAF3', flexShrink: 0 }
  });
}
...
function BottomNav({ screen, onNavigate }) {
  ...
  return React.createElement('div', {
    style: {
      background: 'white', boxShadow: '0 -1px 0 rgba(30,20,8,0.06)',
